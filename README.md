...
`NAVER_CLIENT_ID`, `NAVER_CLIENT_SECRET`은 Daily 한국 개발/AI 뉴스 품질 향상용입니다. Career Site Radar에서는 사용하지 않습니다.
...
7. Daily와 Career Site Radar를 각각 `Run workflow`로 1회 수동 실행해 Discord 도착 여부를 확인합니다.
8. 이후 Daily만 평일 08:47 KST에 자동 실행됩니다.
...
그래서 Daily는 00분/30분을 피하고 08:47 KST로 실행합니다.
