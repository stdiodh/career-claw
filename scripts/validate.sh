...
required_files=(
  ...
  "docs/assets/getting-started/03-secrets-add-secret-form.png"
  "docs/assets/getting-started/04-variables-tab-new-variable.png"
  "docs/assets/getting-started/05-variables-add-variable-form.png"
