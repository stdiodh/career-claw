...
> Language: [한국어](../../kr/project/adoption-evidence.md) | [English](./adoption-evidence.md)

This document defines a safe way to collect real Career Feed usage and feedback signals without inventing metrics.

Career Feed does not currently claim broad adoption, downloads, stars, active users, or organization usage.

## Purpose

The goal is to collect only verifiable feedback that early users and contributors can share in public issues.

Evidence used in README, release notes, or application documents must be public, redacted, and permission-aware.
...
Useful evidence names the workflow, locale, artifact path, dry-run settings, and validation result.
...
Do not use the following in README, application docs, release notes, or ecosystem positioning.
...
Do not collect private Discord channel names, invite links, user names, profile images, or message screenshots as public evidence.
...
- [ ] Evidence comes from a public issue, pull request, or public discussion.
