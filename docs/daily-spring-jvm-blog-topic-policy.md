...
- 30분 학습은 공식 문서에서 확인할 키워드와 읽기 목표를 2~3개 행동으로 쪼갭니다.
- 30분 실습은 손으로 확인 가능한 행동이어야 합니다.
...
- Spring, Hibernate, OpenJDK, Kotlin, Gradle, Micrometer, OpenTelemetry, Docker, Kubernetes, 주요 Cloud 공식 문서를 우선합니다.
