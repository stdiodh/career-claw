...
> Language: [한국어](./README.md) | [English](../en/README.md)

Career Feed 문서는 처음 실행하는 사용자, 반복 운영자, 기여자, maintainer가 보는 문서를 분리합니다.

처음 방문했다면 아래 경로에서 시작하세요.

## New Here?

| 원하는 것 | 읽을 문서 |
| --- | --- |
| 결과 먼저 보기 | [Sample Output](./getting-started/sample-output.md) |
| 바로 설치하기 | [Fork Setup Guide](./getting-started/fork-setup.md) |
| 설정 변경하기 | [Runtime Configuration](./getting-started/runtime-configuration.md) |
| 운영하기 | [Usage Guide](./getting-started/usage.md) |
...
| Document | Purpose |
| --- | --- |
| [Sample Output](./getting-started/sample-output.md) | 대표 산출물 예시와 검토 포인트 |
| [Demo Guide](./demo.md) | GitHub Actions, artifact, generated Markdown, Discord 출력 데모 기준 |
...
| [Shared Roadmap](../project/roadmap.md) | published v0.2.0, prepared v0.2.1, v0.3.0 계획 기준 |
| [Codex for OSS Application](./project/codex-for-oss-application.md) | 정직한 신청 문서 기준 |
| [Promotion Readiness](./project/promotion-readiness.md) | prepared v0.2.1 기준 공개 피드백 점검 |
| [Changelog](../../CHANGELOG.md) | 변경 이력 |
| [Release Checklist](./project/release-checklist.md) | maintainer용 릴리스 전 점검 |
| [v0.2.0 Release Notes](./release-notes/v0.2.0.md) | locale foundation 릴리스 기록 |
...
| Document | Purpose |
| --- | --- |
| [README](../../README.md) | 프로젝트 랜딩과 Quick Start |
