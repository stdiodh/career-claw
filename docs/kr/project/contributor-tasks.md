...
> Language: [한국어](./contributor-tasks.md) | [English](../../en/project/contributor-tasks.md)
...
- Clarify one confusing setup step in `docs/kr/getting-started/fork-setup.md`.
...
- `docs/kr/getting-started/fork-setup.md` remains readable.
...
- Improve one example in `docs/kr/getting-started/runtime-configuration.md`.
...
- Improve `docs/kr/getting-started/sample-output.md`.
