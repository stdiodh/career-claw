...
> Language: [한국어](./CONTRIBUTING.md) | [English](../en/CONTRIBUTING.md)
...
상세 기준은 [Good suggestion criteria](contributing/good-suggestion-criteria.md)를 참고해 주세요.

## Before opening an issue

이슈를 열기 전에 README와 관련 문서를 먼저 확인해 주세요.

fork 실행이나 설정에서 막혔다면 [Fork Setup Guide](getting-started/fork-setup.md)와
[Runtime Configuration](getting-started/runtime-configuration.md)을 먼저 확인해 주세요.

demo나 screenshot 제안은 [Demo guide](demo.md)의 redaction 기준을 따릅니다.
...
Blank issue는 닫혀 있으므로 가장 가까운 전용 템플릿을 선택해 주세요.
...
GitHub Actions 수동 실행과 artifact 확인 흐름은 [Usage Guide](getting-started/usage.md)를 참고해 주세요.
...
자세한 문서 기여 흐름은 [Contribution guide index](contributing/README.md)를 참고해 주세요.
...
자세한 기준은 [Source suggestion guide](contributing/source-suggestion-guide.md)를 참고해 주세요.
...
자세한 기준은 [OSS candidate suggestion guide](contributing/oss-candidate-guide.md)를 참고해 주세요.
최종 추천 정책은 [OSS Candidate Policy](policies/oss-candidate-policy.md)를 따릅니다.
...
자세한 작성 기준은 [Backend career question guide](contributing/backend-career-question-guide.md)를 참고해 주세요.
...
자세한 기준은 [Maintainer review policy](contributing/review-policy.md)를 참고해 주세요.
...
- [Contribution guide index](contributing/README.md)
- [Contributor Task Ideas](project/contributor-tasks.md)
- [Roadmap](project/roadmap.md)
- [Good suggestion criteria](contributing/good-suggestion-criteria.md)
- [Source suggestion guide](contributing/source-suggestion-guide.md)
- [OSS candidate suggestion guide](contributing/oss-candidate-guide.md)
- [Backend career question guide](contributing/backend-career-question-guide.md)
- [Maintainer review policy](contributing/review-policy.md)
