...
> Language: [한국어](./good-suggestion-criteria.md) | [English](../../en/contributing/good-suggestion-criteria.md)

## Summary

제안은 maintainer가 검토할 수 있는 자료여야 합니다.

좋은 제안은 자동화가 바로 실행할 명령이 아니라, 프로젝트 목적에 맞는지 판단할 수 있는 맥락을 제공합니다.

초기 단계의 공개 OSS이므로 큰 claim보다 작은 근거를 더 중요하게 봅니다.
...
"추가해 주세요"에서 끝나지 않고 왜 추가할 가치가 있는지 설명합니다.
